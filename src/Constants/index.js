...
export const TableStyling = {
	...
	avatarStyle: { width: "100%", height: "auto", maxWidth: 40, maxHeight: 40 },
};
...
export const countryNewList = Country.getAllCountries();
...
colorsssss
*/
export const primaryColor = "#002140";
export { union };

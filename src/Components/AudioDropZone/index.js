...
import "./index.css";
function AudioDropZone({ setImageUrl, small = false }) {
	...
	return isLoading ? (
		...
		<div
			...
			style={{ width: 298, height: 130 }}
		>
			{isDragActive ? (
				!small && <p>Drop the files here ...</p>
			) : (
				<div className="colCenteral drpzn" style={{ width: 298, height: 108 }}>
					<input {...getInputProps()} />
					<div className="rowing">
						<div className="plusAddSign" style={{ marginRight: 0 }}>
